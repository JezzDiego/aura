...
import com.example.aura.presentation.navigation.destinations.navigateToNewsDetailsScreen
...
@Composable
fun NewsScreen(container: AppContainer, navController: NavController){
                            ...
                            content = {
                                ...
                                items(articles) { article ->
                                    NewsCard(article, Modifier.clickable{
                                        navController.navigateToNewsDetailsScreen(article.id)
                                    })
                                }
                            }
                        )
